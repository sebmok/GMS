    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.NavItemsDicts", t => t.NavItemId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.NavConfigTemplatesGlobalNameDict", t => t.TemplateNameId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        IdNavItem = c.Int(nullable: false, identity: true),
                        NavItemName = c.String(nullable: false, maxLength: 30),
                        NavItemController = c.String(maxLength: 60),
                        NavItemAction = c.String(maxLength: 100),
                        NavItemImageClass = c.String(maxLength: 100),
                        IsActiveLi = c.Boolean(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        DefaultFormId = c.Int(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.NavConfigTemplates", "TemplateNameId", "dbo.NavConfigTemplatesGlobalNameDict");
            DropForeignKey("dbo.MemberUserQuickMenus", "TemplateId", "dbo.NavConfigTemplates");
            DropForeignKey("dbo.NavItemsDicts", "GlyphId", "dbo.GlyphsDicts");
            DropForeignKey("dbo.MemberUserNavConfigs", "NavItemId", "dbo.NavItemsDicts");
            ...
            DropIndex("dbo.NavItemsDicts", new[] { "GlyphId" });
